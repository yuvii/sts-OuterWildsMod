...
@SpireInitializer
public class outerwildsmod implements
    ...
    private static final String resourcesFolder = "outerwildsmod";
    ...
    private static final Color cardColor = new Color(255f/255f, 125f/255f, 37f/255f, 1f);
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(Hearthian.Enums.CARD_COLOR, cardColor, BG_ATTACK, BG_SKILL, BG_POWER, ENERGY_ORB,
                BG_ATTACK_P, BG_SKILL_P, BG_POWER_P, ENERGY_ORB_P,
                SMALL_ORB);
    }

    public outerwildsmod() {
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(outerwildsmod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new Hearthian(),
                CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, Hearthian.Enums.THE_HEARTHIAN
                );
    }
