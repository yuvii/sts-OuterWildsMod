package outerwildsmod.character;
...
import static outerwildsmod.outerwildsmod.characterPath;
import static outerwildsmod.outerwildsmod.makeID;


public class Hearthian extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("TheHearthian"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_HEARTHIAN;
        @SpireEnum(name = "HEARTHIAN_BLACKORANGE") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "HEARTHIAN_BLACKORANGE") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public Hearthian() {
        super(NAMES[0], Enums.THE_HEARTHIAN,
